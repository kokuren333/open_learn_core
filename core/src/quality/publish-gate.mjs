...
export async function evaluatePublishGate({ dataset, validation, conceptId = null, auditDir = null }) {
  conceptId ??= dataset.concepts?.[0]?.value?.id;
  auditDir ??= path.join(dataset.domainRoot ?? dataset.root, "working", conceptId, "audit");
