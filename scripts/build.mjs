...
for (const domain of domains) {
  ...
  portalEntries.push({ id: domain.id, title: domain.manifest.title, description: domain.manifest.description, url: `/domains/${publishPath}/`, curricula: manifest.curricula, conceptCount: manifest.conceptCount, status: domain.manifest.status });
}
